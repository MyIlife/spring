...
public class MyBeanDefinitionRegistryPostProcessor1 implements BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        System.out.println("BeanDefinitionRegistryPostProcessor后置处理器MyBeanDefinitionRegistryPostProcessor1111.postProcessBeanDefinitionRegistry执行");
    }

    @Override
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        System.out.println("BeanDefinitionRegistryPostProcessor后置处理器MyBeanDefinitionRegistryPostProcessor1111.postProcessBeanFactory执行");
    }
}
